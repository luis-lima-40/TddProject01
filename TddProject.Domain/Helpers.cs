...
namespace TddProject.Domain
{
    public static class Helpers
    {
        ...
        public static Exception ConvertStringListToException(List<string> mensagens) //o retorno desse metodo é do tipo Exception e o nome será ConvertStringListToException() para denotar exatamente a o objetivo do metodo, ele vai receber como parametro de entrada uma List<string>
        {
